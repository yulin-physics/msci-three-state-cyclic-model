...
lattice = GHCA()
lattice.perturb()
#data = pd.read_csv('256_test.csv', header=None)
#lattice.plot_leaderDistribution(data[1].values)
...
# =============================================================================
# data = pd.read_csv('4096_log_open.csv', header=None)
# 
# plt.figure(3)
# ax = plt.gca()
...
# =============================================================================
# data = pd.read_csv('128_dn_open.csv', header=None)
# 
# prep_y=list(data[1])
# prep_x=list(data[0])
# i=0
