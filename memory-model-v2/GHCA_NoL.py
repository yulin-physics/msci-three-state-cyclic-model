# -*- coding: utf-8 -*-
"""
Created on Tue Jan 26 09:50:36 2021
...
R = 1024 #Refractory period/time step delay from R to Q
T = 24*10**6 #Number of time steps to run for
...
class GHCA:
    ...
    def plot_leaderNum(self):
        ...
        print(counts)
        NoL = list(counts.keys())
        number = list(counts.values())
    

        plt.scatter(NoL, number, s=0.8)
